...
def _ai_build_brief(project: Project, contract: dict, workflow: dict, findings: list[dict], metadata: dict) -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            _subsection_list("Known constraints", _list_values(contract, "product_intent", "known_constraints")),
            "",
            _subsection_list("Risks", _list_values(contract, "product_intent", "risks")),
            "",
            _subsection_list("Unresolved assumptions", _list_values(contract, "product_intent", "assumptions")),
            "",
